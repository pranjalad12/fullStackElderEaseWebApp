...
const Footer = () => {
  return (
    <>
      <footer className="border-t border-stroke dark:border-strokedark dark:bg-blacksection bg-gradient-to-t from-transparent to-[#dee7ff47] dark:bg-gradient-to-t dark:to-[#252A42] mx-50">
