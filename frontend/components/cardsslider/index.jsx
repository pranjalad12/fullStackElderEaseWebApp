...
<SwiperSlide>
								<div class="h-full  w-full pt-12 p-4">
										...
										<div data-aos-delay="150" class="rounded-xl bg-white p-6 text-center shadow-xl">
											...
											<p class="px-4 text-gray-500 text-xl">{clicks["Vajrasana"]}</p>
											<h1 class="text-darken mb-3 text-xl font-medium lg:px-14">Vajrasana</h1>
										</div>
							...
							<SwiperSlide>
								<div class="h-full  w-full pt-12 p-4">
										<div class="rounded-xl bg-white p-6 text-center shadow-xl">
											...
											<h1 class="text-darken mb-3 text-xl font-medium lg:px-14">Warrior Pose</h1>
										</div>
							...
							<SwiperSlide>
								<div class="h-full  w-full pt-12 p-4">
										<div data-aos-delay="300" class="rounded-xl bg-white p-6 text-center shadow-xl">
											...
											<p class="px-4 text-gray-500 text-xl">{clicks["Vrikshasana"]}</p>
											<h1 class="text-darken mb-3 text-xl font-medium lg:px-14">Vrikshasana</h1>
							...
							<SwiperSlide>
								<div class="h-full  w-full pt-12 p-4">
										<div class="rounded-xl bg-white p-6 text-center shadow-xl">
											...
											<p class="px-4 text-gray-500 text-xl">{clicks["Phalakasana"]}</p>
											<h1 class="text-darken mb-3 text-xl font-medium lg:px-14">Phalakasana</h1>
										</div>
							...
							<SwiperSlide>
								<div class="h-full  w-full pt-12 p-4">
										<div data-aos-delay="300" class="rounded-xl bg-white p-6 text-center shadow-xl">
											...
											<p class="px-4 text-gray-500 text-xl">{clicks["T Pose"]}</p>
											<h1 class="text-darken mb-3 text-xl font-medium lg:px-14">T Pose</h1>
							...
							<SwiperSlide>
								<div class="h-full  w-full pt-12 p-4">
										<div data-aos-delay="300" class="rounded-xl bg-white p-6 text-center shadow-xl">
											...
											<p class="px-4 text-gray-500 text-xl">{clicks["Padmasana"]}</p>
											<h1 class="text-darken mb-3 text-xl font-medium lg:px-14">Padmasana</h1>
