...
const Testimonial = ({clicks}) => {
	...
	return (
		<>
			<section >
				<div className="mx-auto max-w-c-1615 px-4 md:px-8 xl:px-0 mt-5">
					{/* <!-- Section Title Start --> */}
							...
							<SwiperSlide>
								<div class="h-full  w-full pt-12 p-4">
										...
										<div data-aos-delay="150" class="rounded-xl bg-white p-6 text-center shadow-xl">
											...
											<p class="px-4 text-gray-500 text-xl">{clicks["Balasana"]}</p>
											<h1 class="text-darken mb-3 text-xl font-medium lg:px-14">Balasana</h1>
										</div>
							...
							<SwiperSlide>
								<div class="h-full  w-full pt-12 p-4">
										<div class="rounded-xl bg-white p-6 text-center shadow-xl">
											...
											<p class="px-4 text-gray-500 text-xl">{clicks["Bhujangasana"]}</p>
											<h1 class="text-darken mb-3 text-xl font-medium lg:px-14">Bhujangasana</h1>
										</div>
